...
//==========================  LIFECYCLE METHODS  =============================
    ...
    openCellEditor: function (e) {
      ...
      if (editorInstance) {
        ...
        Y.later(500, this, function () {
          // This is needed because row selection / highlighting and related
          // binder actions that get invoked on the first click may not have
          // by the time the second click is madefinished, rendering the td's
          // co-ordinates incorrect.
    ...
    getColumnNameByTd: function (cell) {
      var
        classes = cell.get('className').split(" "),
...
//==========================  PRIVATE METHODS  =============================
    ...
    _bindEditable: function () {
      ...
      if (eotype) {
        ...
        this._subscrEditOpen = this.delegate(
          eotype,
          this.openCellEditor,
    ...
    _createCellEditorInstance: function(editorName, column) {
      var
        conf_obj = Y.clone(Y.DataTable.EditorOptions[editorName], true),
