/*global YUI: true */
/*jslint nomen: true */
YUI.add('paginator-view', function (Y, NAME) {
  ...
  Y.PaginatorModel = Y.Base.create('paginatorModel', Y.Model,[],{
    ...
    initializer: function () {
      console.log('PaginatorModel.initializer()');
  ...
  //================   P R I V A T E    P R O P E R T I E S     ====================
      ...
      _disablePageSelector : function(linkSel, visible){
        Y.log(['_disablePageSelector', linkSel, visible]);
        linkSel = ( !Y.Lang.isArray(linkSel) ) ? [ linkSel ] : linkSel;
        visible = ( visible ) ? visible : false;
        var
          sel_srch = '[data-{suffix}="{sdata}"]',
          pag_cont = this.get('container');
