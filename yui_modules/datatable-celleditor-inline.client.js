...
YUI.add('gallery-datatable-celleditor-inline', function (Y, NAME) {
  ...
  **/
  ...
  Y.DataTable.BaseCellInlineEditor =  Y.Base.create(
    'celleditor',
    Y.View,
    [],
    {
      ...
      showEditor: function (td) {
        ...
        cont.show();
        this._resizeCont(cont, this._inputNode, td);
        cont.setXY(xy);
       ...
       * @private
       */
      _resizeCont: function (cont, input, td) {
        var
          w   = this._parseStyle(td, 'width'),
